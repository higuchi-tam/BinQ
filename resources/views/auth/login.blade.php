      ...
      <div class="p-login__addressWrap">
        ...
        <form class="new_user" id="new_user" action="{{ route('login') }}" accept-charset="UTF-8" method="post">
            ...
            <div class="p-login__formGroup">
              <input id="email" type="email" class="p-login__formItem" name="email"  placeholder="メールアドレス" value="{{ old('email') }}" required autofocus>
            </div>
            <div class="form-group">
              <input id="password" type="password" class="p-login__formItem" name="password" placeholder="パスワード" required>
            </div>
            <a href="" class="p-login__passRemind">パスワードを忘れた方</a>
            <div class="c-button__wrap">
              <input type="submit" name="commit" value="ログイン" class="c-button__login">
            </div>
        </form>
    </div>
