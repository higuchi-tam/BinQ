...
Route::prefix('users')->name('users.')->group(function () {
    ...
    Route::get('/{name}/setting', 'UserController@setting')->name('setting');
    ...
    Route::post('/{name}/delete', 'UserController@delete')->name('delete');
    Route::get('/{name}/delete/confirm', 'UserController@deleteConfirm')->name('delete.confirm');
